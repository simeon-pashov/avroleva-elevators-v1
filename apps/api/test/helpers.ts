...
export async function resetDb(): Promise<void> {
  await prismaBase.$executeRawUnsafe(
    'TRUNCATE TABLE "audit_log", "domain_event", "payment", "invoice", "invoice_sequence", "visit_technician", "visit", "import_batch", "contract_elevator", "contract", "elevator", "contact", "building", "customer", "session", "user", "tenant", "platform_admin" CASCADE',
  )
}

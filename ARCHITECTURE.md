...
| billing | invoice, invoice_line, invoice_sequence, payment, credit_note | draftPeriod, issue, recordPayment, void(creditNote), pushExternal · arrears, unpaidFlag(buildingId) | InvoiceIssued, PaymentRecorded, InvoiceOverdue | ContractStarted/Terminated |
